...
Langkah eksekusi lengkap (menjalankan `docker compose up`, membuka `http://localhost:8000`, dan mencoba chat) ada di **Langkah 1-4 `PANDUAN-PRAKTIK.md`**. Yang perlu dipastikan sebelum lanjut ke Module 6:
