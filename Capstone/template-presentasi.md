...
Tunjukkan (boleh pakai diagram Mermaid dari materi Module 4 atau Module 26 sebagai basis, disesuaikan) arsitektur NALA yang dipakai:
...
2. **Pertanyaan RAG** — tanyakan sesuatu yang jawabannya ada di dokumen SOP, tunjukkan badge "Dokumen SOP (RAG)" (Module 28) muncul, dan jawabannya sesuai isi dokumen.
...
- Model `llama3.2:3b` vs model lebih besar (akurasi vs resource, README utama & Module 21-25)
- Grounding ketat (menolak menjawab di luar konteks) vs fleksibilitas jawaban (Module 13 Bagian 4)
- Vector search murni vs hybrid search + reranking (Module 17-20, Module 13 Bagian 7)
- Airflow scheduled ingest vs upload endpoint instan (Module 13 Bagian 5)
- Bagaimana agent Anda menangani ambiguitas routing RAG vs SQL (Module 21-25)
- Risiko keamanan yang diakui tapi belum diselesaikan penuh (prompt injection, rate limiting — Module 27 Bagian 3)
