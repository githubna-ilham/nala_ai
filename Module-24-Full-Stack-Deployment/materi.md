...
Dibanding akhir Module 23, ada empat penambahan/perubahan di project kerja peserta (`resources/starter-code/day-5/nala/` — hasil menyalin `day-4/nala/`, lihat `PANDUAN-PRAKTIK.md` Langkah 1). Dibangun bertahap dalam 3 Tahap:
...
- Folder resources/starter-code/day-5/nala/ adalah hasil salinan
  day-4/nala/ (lihat PANDUAN-PRAKTIK.md Langkah 1).
...
Urutan startup yang realistis (detail lengkap dengan perintah ada di `PANDUAN-PRAKTIK.md`):
...
Untuk kelas dengan variasi RAM laptop yang lebar, pertimbangkan opsi ini (dibahas juga di `PANDUAN-PRAKTIK.md` bagian troubleshooting):
