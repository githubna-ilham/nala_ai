...
### Prasyarat
- Sudah menyelesaikan **Module 10** (Setup Knowledge Base & Data Dasar Awal)
...
- **`Internal Server Error` saat memanggil `embed_text()` atau saat ingest**: cek dulu model mana yang belum ter-pull (`docker compose exec ollama ollama list`) — module ini butuh dua model sekaligus: `llama3.2:3b` (dari Module 7) dan `nomic-embed-text` (Langkah 1 di atas). Kalau salah satu tidak muncul, ulangi langkah pull yang sesuai.
