...
5. Menambahkan lapisan operasional dengan Redis (cache jawaban, job queue untuk upload, rate limiting per-IP), mem-polish frontend supaya siap didemokan, mengenali delapan arsitektur RAG beserta gejala yang menandakan masing-masing dibutuhkan, memahami prinsip umum etika & governance AI — bias, overreliance, akuntabilitas — dan menguji perilaku stack di bawah beban (Module 28-32)
...
30. **[Module 30: Jenis-Jenis Arsitektur RAG](Module-30-Jenis-Arsitektur-RAG/materi.md)** — Sesi teori murni (tanpa kode): delapan arsitektur RAG beserta diagram alur masing-masing — Naive, Hybrid, Reranked, Multi-Query/RAG-Fusion, Multimodal, Agentic, Corrective (CRAG), dan Self-RAG — dipisahkan antara yang memperbaiki kualitas retrieval dan yang memperbaiki kontrol alur. Tiap arsitektur disertai masalah yang diselesaikannya, gejala yang menandakan kapan dibutuhkan, dan harganya.
