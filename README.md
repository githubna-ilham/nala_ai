...
30. **[Module 30: Jenis-Jenis Arsitektur RAG](Module-30-Jenis-Arsitektur-RAG/materi.md)** — Sesi teori murni (tanpa kode): sebelas arsitektur RAG beserta diagram alur masing-masing — Naive, Hybrid, Reranked, Multi-Query/RAG-Fusion, Hierarchical, Graph, Multimodal, Agentic, Corrective (CRAG), Self-RAG, dan Adaptive — dipisahkan antara yang memperbaiki kualitas retrieval dan yang memperbaiki kontrol alur. Tiap arsitektur disertai masalah yang diselesaikannya, gejala yang menandakan kapan dibutuhkan, dan harganya.
