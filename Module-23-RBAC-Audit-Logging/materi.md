...
Langkah eksekusi lengkap ada di bagian **Panduan Praktik** di bawah (Langkah 17-21). Yang perlu dipastikan sebelum rangkaian Module 19-23 dianggap selesai:
...
> Catatan penomoran: bagian ini memakai penomoran "Langkah" tersendiri (melanjutkan urutan global lintas-module: Module 19 = Langkah 1-5, Module 20 = Langkah 6-10, Module 21 = Langkah 11-13, Module 22 = Langkah 14-16, module ini = Langkah 17-21) yang berbeda dari "Langkah 1-4" di dalam bagian struktur kode materi.md di atas — keduanya kebetulan bertumpang tindih penomoran tapi berasal dari dua urutan yang terpisah, peninggalan dari saat panduan ini masih satu dokumen gabungan Module 19-23. Ini adalah bagian Panduan Praktik terakhir dari rangkaian Module 19-23.

**Panduan Praktik — Module 23: RBAC & Audit Logging**

Lanjutan langsung dari bagian Panduan Praktik di materi Module 22 — agent dengan routing dua-tool dan pengaman `MAX_TOOL_ROUNDS`/`force_answer` harus sudah jalan sebelum mulai di sini. Penomoran Langkah melanjutkan penomoran global (Module 19: Langkah 1-5, Module 20: Langkah 6-10, Module 21: Langkah 11-13, Module 22: Langkah 14-16).
