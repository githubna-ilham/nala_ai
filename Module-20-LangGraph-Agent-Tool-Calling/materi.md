...
`resources/starter-code/day-4/nala/` **belum ada** (lihat `PANDUAN-PRAKTIK.md` Module 19) — bangun dari salinan `day-3/nala/` mengikuti `PANDUAN-PRAKTIK.md` Langkah 1. Tiga tahap di module ini:
...
Langkah eksekusi lengkap ada di **Langkah 6-10 `PANDUAN-PRAKTIK.md`**. Yang perlu dipastikan sebelum lanjut ke Module 21:
