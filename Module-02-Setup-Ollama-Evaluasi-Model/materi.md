...
Worksheet tersebut menggunakan Ollama yang terinstall **langsung di laptop** (bukan di dalam container). Setup Ollama versi containerized (di dalam Docker, untuk aplikasi NALA) baru dilakukan di **Module 4** (`Module-04-Setup-Infra-Docker-Compose/materi.md`, section 3.4).
