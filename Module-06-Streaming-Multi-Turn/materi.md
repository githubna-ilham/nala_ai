...
Dibanding akhir Module 5, ada beberapa perubahan di `Nala/`. Sama seperti Module 5, dibangun **bertahap dalam 3 tahap**:
...
### Prasyarat
- Sudah menyelesaikan **Module 5** (Chat UI Dasar) — container `ollama`+`api` dari `Nala/` masih berjalan (kalau tidak, ulangi Module 5 Langkah 2)
